<section class="registaion-area">
        <div class="container">
            ...
            <!-- end of col md 6 -->
                <div class="col-md-6">
                    <form class="form-horizontal" action="registation_do.php" method="post" >
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="password" class="form-control" name="hashed_password" id="inputEmail3" placeholder="Password">
                        </div>
                      </div>
